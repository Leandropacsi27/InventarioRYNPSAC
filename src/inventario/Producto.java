...
public class Producto {
    ...
    public void Insertar(JTextField Nombre, JTextField Marca, JTextField PCompra, JTextField Cantidad, JTextField Proveedor, JTextField PVenta){        
    ...
    public void ModificarProducto(JTextField Codigo, JTextField Nombre, JTextField Marca, JTextField PCompra, JTextField Cantidad, 
        ...
        String consulta = "UPDATE productos SET productos.Nombre =?, productos.Marca =?,productos.PCompra=?,productos.Cantidad=?,productos.Proveedor=?,productos.PVenta=? WHERE productos.Código=?;";
    ...
    public void SeleccionarProducto(JTable table, JTextField Codigo, JTextField Nombre, JTextField Marca, JTextField PCompra, JTextField Cantidad, 
            JTextField Proveedor, JTextField PVenta) {
